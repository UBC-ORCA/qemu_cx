...
static const VMStateDescription vmstate_hyper = {
    ...
    .fields = (const VMStateField[]) {
        ...
        VMSTATE_UINTTL(env.ucx_sel, RISCVCPU),
        VMSTATE_UINTTL(env.cx_status, RISCVCPU),
        VMSTATE_UINTTL(env.mcx_enable0, RISCVCPU),
        VMSTATE_UINTTL(env.mcx_enable1, RISCVCPU),
        VMSTATE_UINTTL(env.mcx_enable2, RISCVCPU),
        VMSTATE_UINTTL(env.mcx_enable3, RISCVCPU),
        VMSTATE_UINTTL(env.mcx_enable4, RISCVCPU),
        VMSTATE_UINTTL(env.mcx_enable5, RISCVCPU),
        VMSTATE_UINTTL(env.mcx_enable6, RISCVCPU),
        VMSTATE_UINTTL(env.mcx_enable7, RISCVCPU),
